...
int main(int argc, char** argv) {
  try {
    if (argc < 4) {
      std::cerr << "Usage: rhoprime_dsigma_dy AuAu|PbPb sqrt_s_NN_GeV tag "
    ...
    const auto summary = rhoprime::GenerateUpcRhoPrimeGrid(cfg);
    ...
    std::cerr << "rhoprime_dsigma_dy: " << e.what() << "\n";
    return 1;
  }
}
